...
type SessionRepositoryMock struct {
	...
	FindActiveByIDFunc func(ctx context.Context, id string) (*domain.Session, error)
}
...
func (m *SessionRepositoryMock) FindActiveByID(ctx context.Context, id string) (*domain.Session, error) {
